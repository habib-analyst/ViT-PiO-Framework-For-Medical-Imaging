...
# Load test data
def load_test_data():
    X_test = np.load("C:\\Users\\hamza\\Downloads\\CancerVsPneumonia\\NPYF\\X_test.npy").astype(np.float32) 
    y_test = np.load("C:\\Users\\hamza\\Downloads\\CancerVsPneumonia\\NPYF\\y_test.npy").astype(int)
...
model = load_model(
    "C:\\Users\\hamza\\Downloads\\AlzVsStr\\vit_perceiver_io_model.h5",
...
# Class names
class_names = ['Lung Cancer', 'Pneumonia']

# Function to save predicted images
def save_predicted_images(X, y_true, y_pred, class_names, num_images=10, output_dir="C:\\Users\\hamza\\Downloads\\AlzVsStr"):
    ...
    plt.tight_layout()
    output_path = os.path.join(output_dir, "predicted_images.png")
