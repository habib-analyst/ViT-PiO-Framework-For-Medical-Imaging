...
# Load test data
def load_test_data():
    X_test = np.load("C:\\Users\\hamza\\Downloads\\AlzVsStr\\NPYF\\X_test.npy").astype(np.float32) 
    y_test = np.load("C:\\Users\\hamza\\Downloads\\AlzVsStr\\NPYF\\y_test.npy").astype(int)
