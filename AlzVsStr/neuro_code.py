...
def load_and_preprocess_data(data_path):
    # Load the .npy files
    data_path = r"C:\Users\hamza\Downloads\AlzVsStr\NPYF"
...
def build_model(input_shape=(224, 224, 3), patch_size=16, num_classes=2):
    ...
    # Apply data augmentation (automatically disabled during evaluation)
...
def plot_history(history):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('vit_perceiver_io_history.png')
    plt.close()
...
if __name__ == "__main__":
    ...
    data_path = os.path.join(os.path.dirname(__file__), "..", "..", "Brain Model", "NPYF")
    ...
    # Save the model
    model.save('vit_perceiver_io_model.h5')
    print("Model saved as 'vit_perceiver_io_model.h5'")
