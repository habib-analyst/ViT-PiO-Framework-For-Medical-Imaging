...
# Load test data
def load_test_data():
    X_test = np.load("C:\\Users\\habib\\Downloads\\Lung Model\\NPYF\\X_test.npy").astype(np.float32) 
    y_test = np.load("C:\\Users\\habib\\Downloads\\Lung Model\\NPYF\\y_test.npy").astype(int)
...
model = load_model(
    "C:\\Users\\habib\\Downloads\\Lung Model\\Model\\vit_perceiver_io_model.h5",
