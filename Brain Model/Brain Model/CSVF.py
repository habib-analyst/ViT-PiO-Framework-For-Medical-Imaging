...
root_dir = "C:\\Users\\habib\\Downloads\\Brain Model\\AlzVsStr"  # replace with the actual path to the dataset
...
for split in ['train', 'test', 'validation']:
    ...
    for category in ['Stroke', 'Alzheimer']:
        ...
        for filename in os.listdir(category_dir):
            if filename.endswith('.jpg') or filename.endswith('.png'):  # adjust extensions if needed
                ...
                label = 1 if category == 'Stroke' else 0  # label 1 for tinea, 0 for melanoma
...
df.to_csv('stroke_alzheimer_dataset.csv', index=False)
