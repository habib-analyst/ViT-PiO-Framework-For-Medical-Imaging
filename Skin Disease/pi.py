...
# Load test data
def load_test_data():
    X_test = np.load("C:\\Users\\hamza\\Downloads\\Skin Disease\\NPYF\\X_test.npy").astype(np.float32) 
    y_test = np.load("C:\\Users\\hamza\\Downloads\\Skin Disease\\NPYF\\y_test.npy").astype(int)
...
model = load_model(
    "C:\\Users\\hamza\\Downloads\\AlzVsStr\\skin_disease_vit_perceiver_io_model.h5",
